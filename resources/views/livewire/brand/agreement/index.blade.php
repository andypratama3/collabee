            ...
            <table class="min-w-full divide-y divide-gray-200/50 dark:divide-gray-700/50">
                <thead>
                    <tr class="bg-gray-50/80 dark:bg-gray-900/50">
                        ...
                        <th class="px-6 py-4 text-left text-[10px] font-bold text-gray-400 dark:text-gray-500 uppercase tracking-wider">KOL</th>
                ...
                <tbody class="divide-y divide-gray-100/50 dark:divide-gray-700/50">
                    @forelse($agreements as $agreement)
                        <tr class="hover:bg-gray-50/80 dark:hover:bg-gray-700/30 transition-colors duration-200">
                            ...
                            <td class="px-6 py-4">
                                <span class="text-sm font-medium text-gray-900 dark:text-white">{{ $agreement->hiring?->kolProfile?->display_name ?? 'N/A' }}</span>
                            </td>
                            ...
                            <td class="px-6 py-4 text-right">
                                <a href="{{ route('brand.agreement.show', $agreement) }}"
                                   class="inline-flex items-center gap-1 text-sm font-medium text-primary dark:text-primary-400 hover:text-primary-800 dark:hover:text-primary-300 transition-colors duration-200">
                                    Lihat
                        ...
                        <tr>
                            <td colspan="6" class="px-6 py-16 text-center">
                                <div class="flex flex-col items-center">
                                    ...
                                    <p class="text-xs text-gray-400 dark:text-gray-500 mt-1">Perjanjian akan muncul setelah proses perekrutan KOL.</p>
                                </div>
                            </td>
                        </tr>
                    @endforelse
