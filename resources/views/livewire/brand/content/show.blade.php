<div>
    <div class="mb-4">
        <a href="{{ route('brand.content.index') }}" wire:navigate class="text-sm text-indigo-600 hover:text-indigo-800">&larr; Kembali</a>
    </div>
        ...
        @if($content->status->value === 'submitted' || $content->status->value === 'under_review' || $content->status->value === 'revision_requested')
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-200">
                    <h3 class="text-lg font-semibold text-gray-900">Review Konten</h3>
                </div>
                <div class="px-6 py-6 space-y-6">
                    ...
                    <div class="border-t pt-6">
                        <h4 class="text-sm font-medium text-gray-700 mb-3">Minta Revisi</h4>
                        ...
                        <button wire:click="requestRevision"
                                class="mt-2 px-4 py-2 text-sm font-medium text-yellow-700 bg-yellow-50 rounded-lg hover:bg-yellow-100">
                            Minta Revisi
                        </button>
                    </div>

                    <div class="border-t pt-6">
                        <h4 class="text-sm font-medium text-gray-700 mb-3">Tolak Konten</h4>
                        ...
                        <button wire:click="reject" wire:confirm="Tolak konten ini?"
                                class="mt-2 px-4 py-2 text-sm font-medium text-red-700 bg-red-50 rounded-lg hover:bg-red-100">
                            Tolak Konten
                        </button>
                    </div>
                </div>
