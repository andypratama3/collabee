<div class="max-w-3xl mx-auto space-y-8">
    <h2 class="text-2xl font-bold text-gray-900">Edit Profil KOL</h2>
    ...
    <form wire:submit="update" class="space-y-8">
        ...
        <div class="space-y-4">
            ...
            @if (empty($social_accounts))
                <p class="text-sm text-gray-500">Belum ada akun sosial media.</p>
            @endif
        ...
        <div class="space-y-4">
            <h3 class="text-lg font-semibold text-gray-800 border-b pb-2">Rekening Bank</h3>
            <p class="text-sm text-gray-500">Rekening untuk pencairan dana withdrawal.</p>

            <div class="grid grid-cols-2 gap-4">
                <div>
                    <label for="bank_name" class="block text-sm font-medium text-gray-700">Nama Bank</label>
                    <input wire:model="bank_name" id="bank_name" type="text" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                    @error('bank_name') <span class="text-sm text-red-600">{{ $message }}</span> @enderror
                </div>

                <div>
                    <label for="bank_code" class="block text-sm font-medium text-gray-700">Kode Bank</label>
                    <input wire:model="bank_code" id="bank_code" type="text" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                </div>
            </div>

            <div>
                <label for="account_name" class="block text-sm font-medium text-gray-700">Nama Pemilik Rekening</label>
                <input wire:model="account_name" id="account_name" type="text" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                @error('account_name') <span class="text-sm text-red-600">{{ $message }}</span> @enderror
            </div>

            <div>
                <label for="account_number" class="block text-sm font-medium text-gray-700">Nomor Rekening</label>
                <input wire:model="account_number" id="account_number" type="text" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
            ...
            <div>
                ...
                <input wire:model="branch" id="branch" type="text" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
            </div>
        </div>
