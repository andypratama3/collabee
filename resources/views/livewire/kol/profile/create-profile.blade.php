    ...
    <div class="mb-8">
        <div class="flex items-center gap-3 mb-2">
            <div class="p-2.5 bg-gradient-to-br from-primary/20 to-primary/5 dark:from-primary/30 dark:to-primary/10 rounded-xl">
                <svg class="w-6 h-6 text-primary dark:text-primary-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path></svg>
            </div>
            <div>
                <h2 class="text-3xl font-extrabold bg-gradient-to-r from-gray-900 to-gray-600 dark:from-white dark:to-gray-300 bg-clip-text text-transparent tracking-tight">Lengkapi Profil KOL</h2>
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Hampir selesai! Berikan informasi detail agar brand mudah menemukan Anda.</p>
            </div>
        </div>
    </div>
            ...
            <div class="p-6 md:p-8 space-y-4">
                @if (empty($social_accounts))
                    <div class="py-10 text-center border-2 border-dashed border-gray-200 dark:border-gray-700 rounded-2xl bg-gray-50/30 dark:bg-gray-900/10">
                        ...
                        <p class="text-sm text-gray-500 dark:text-gray-400">Belum ada akun sosial media yang ditambahkan. Tambahkan setidaknya satu.</p>
                    </div>
                @else
