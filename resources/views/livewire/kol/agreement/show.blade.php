<div>
    <!-- Back Navigation -->
    <div class="mb-6">
        <a href="{{ route('kol.agreement.index') }}" class="inline-flex items-center gap-1.5 text-sm font-medium text-gray-500 dark:text-gray-400 hover:text-primary dark:hover:text-primary-400 transition-colors duration-200 group">
