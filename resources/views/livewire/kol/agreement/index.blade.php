                ...
                <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                    @forelse($agreements as $agreement)
                        <tr>
                            ...
                            <td class="px-6 py-4">
                                <span class="text-sm text-gray-900 dark:text-white">{{ $agreement->hiring->brandProfile->user->name ?? 'N/A' }}</span>
                            </td>
                            ...
                            <td class="px-6 py-4 text-right">
                                <a href="{{ route('kol.agreement.show', $agreement) }}" class="text-sm text-indigo-600 dark:text-indigo-400 hover:text-indigo-800 dark:hover:text-indigo-300">Lihat</a>
                            </td>
                        </tr>
                    @empty
                        <tr>
