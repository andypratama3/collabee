<div>
    <div class="mb-4">
        <a href="{{ route('kol.chat.index') }}" class="text-sm text-indigo-600 hover:text-indigo-800">&larr; Back to Messages</a>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden flex flex-col h-[calc(100vh-12rem)]">
        <div class="px-6 py-4 border-b border-gray-200 flex items-center gap-3 shrink-0">
            ...
            <div>
                <p class="text-sm font-medium text-gray-900">{{ $room->hiring?->brandProfile?->user?->name ?? 'Unknown Brand' }}</p>
