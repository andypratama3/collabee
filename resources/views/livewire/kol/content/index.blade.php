<div>
    <div class="sm:flex sm:items-center sm:justify-between mb-6">
        <div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Konten Saya</h1>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Kelola konten yang telah kamu kirim</p>
        </div>
        <a href="{{ route('kol.content.create') }}" wire:navigate
           class="mt-3 sm:mt-0 inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-indigo-600 rounded-lg hover:bg-indigo-700">
            Upload Konten Baru
        </a>
    </div>
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 text-right">
                                <a href="{{ route('kol.content.show', $content) }}" wire:navigate
                                   class="text-sm text-indigo-600 dark:text-indigo-400 hover:text-indigo-800 dark:hover:text-indigo-300">Detail</a>
                            </td>
                        </tr>
                    @empty
                        <tr>
                            <td colspan="5" class="px-6 py-12 text-center text-gray-500 dark:text-gray-400">Belum ada konten.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
