<div>
    <div class="sm:flex sm:items-center sm:justify-between mb-6">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-500">Kelola konten yang telah kamu kirim</p>
        </div>
            ...
            <tbody class="divide-y divide-gray-200">
                @forelse($contents as $content)
                    <tr>
                        ...
                        <td class="px-6 py-4 text-sm text-gray-600">{{ $content->brandProfile?->brand_name ?? 'N/A' }}</td>
                        <td class="px-6 py-4">
                        ...
                        <td class="px-6 py-4 text-right">
                            <a href="{{ route('kol.content.show', $content) }}" wire:navigate
                               class="text-sm text-indigo-600 hover:text-indigo-800">Detail</a>
                        </td>
                    </tr>
                @empty
                    <tr>
                        <td colspan="5" class="px-6 py-12 text-center text-gray-500">Belum ada konten.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
