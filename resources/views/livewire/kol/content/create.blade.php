<div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
        ...
        <form wire:submit="save" class="px-6 py-6 space-y-6">
            <div>
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Pilih Agreement</label>
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Judul Konten</label>
            ...
            <div>
                ...
                <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 dark:border-gray-600 border-dashed rounded-lg hover:border-indigo-400 transition-colors">
                    <div class="space-y-1 text-center">
                        ...
                        <p class="text-xs text-gray-500 dark:text-gray-400">JPG, PNG, GIF, WebP, MP4, MOV, PDF, DOC hingga 50MB</p>
                    </div>
                </div>
                    ...
                    <div class="mt-4 grid grid-cols-4 gap-3">
                        @foreach($files as $file)
                            <div class="relative group">
                                <div class="aspect-square rounded-lg bg-gray-100 dark:bg-gray-700 flex items-center justify-center overflow-hidden">
                                ...
                                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400 truncate">{{ $file->getClientOriginalName() }}</p>
                            </div>
                        @endforeach
                    </div>
                @endif
            ...
            <div class="flex items-center gap-3 pt-4 border-t dark:border-gray-700">
                ...
                <a href="{{ route('kol.content.index') }}" wire:navigate
                   class="px-4 py-2.5 text-sm font-medium text-gray-700 dark:text-gray-300 bg-gray-100 dark:bg-gray-700 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-600">
                    Batal
                </a>
            </div>
        </form>
