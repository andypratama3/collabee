...
<div class="w-full">
    ...
    @if (session('status'))
        <div class="mb-6 p-4 text-sm text-emerald-700 dark:text-emerald-300 bg-emerald-50 dark:bg-emerald-900/30 rounded-xl border border-emerald-200 dark:border-emerald-800/50 flex items-start gap-3">
